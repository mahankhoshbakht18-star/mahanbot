            ...
            while attempt < self.retry_limit:
                ...
                try:
                    ...
                    if self._is_visible(page, "#ctl00_ContentPlaceHolder1_btnContinue1"):
                        ...
                        self.log("✅ کد پیامک تازه دریافت شد.", "success", page)
                        ...
                        if not self.fill_field(page.locator(otp_selector).first, otp_value):
    ...
    def _handle_captcha_human(self, page, input_selector, btn_selector):
        try:
            ...
            if code and len(code) >= 4:
                if not self.fill_field(page.locator(input_selector), code):
                    return False
                time.sleep(0.5)
